    ...
    <main className='w-full h-auto flex flex-col justify-center items-center gap-5 py-12'>
      <section className='max-w-[300px] w-[300px] md:max-w-[600px] md:w-[600px] flex flex-col gap-4 px-4 py-2'>
          ...
          <table className='w-full table-fixed text-[9px] md:text-xs text-center border'>
            ...
            <thead>
              ...
              <tr className='bg-slate-100 border'>
                <th className='w-24 px-3 py-1 md:w-44 border md:px-7 md:py-3'></th>
                <th className='w-24 px-3 py-1 md:w-44 border md:px-7 md:py-3'>月曜日</th>
                <th className='w-24 px-3 py-1 md:w-44 border md:px-7 md:py-3'>火曜日</th>
                <th className='w-24 px-3 py-1 md:w-44 border md:px-7 md:py-3'>水曜日</th>
                <th className='w-24 px-3 py-1 md:w-44 border md:px-7 md:py-3'>木曜日</th>
                <th className='w-24 px-3 py-1 md:w-44 border md:px-7 md:py-3'>金曜日</th>
                <th className='w-24 px-3 py-1 md:w-44 border md:px-7 md:py-3'>土曜日</th>
              </tr>
            </thead>
            <tbody>
              {/* 2列目 */}
              <tr className='border'>
                <td className='bg-slate-100 border px-7 py-3'>1限目<br />9：10 ~ 10：40</td>
                <td className='bg-sky-200 px-7 border py-3'>
                  ...
                  <span className='inline-block my-5'>
                    <label htmlFor='ceh-1-checkbox' className='w-full flex md:block flex-col py-3 text-[9px] md:text-xs text-slate-900 cursor-pointer'>
                      <input
                        ...
                        type='checkbox'
                        checked={selected[1]}
                        className='scale-75 align-middle text-blue-600 bg-slate-100 border-slate-300 rounded focus:ring-blue-500 focus:ring-2 cursor-pointer'
                        // 選択したら状態管理変数に真偽値を代入
                ...
                <td className='bg-amber-200 px-7 border py-3'>Linux<br />8×9<br /><br />303C</td>
                <td className='px-7 border py-3'></td>
                <td className='px-7 border py-3'></td>
                <td className='bg-sky-200 px-7 border py-3'>
                  ...
                  <span className='inline-block my-5'>
                    <label htmlFor='web-app-checkbox' className='w-full py-3 text-[9px] md:text-xs text-slate-900 cursor-pointer'>
                      <input
                        ...
                        type='checkbox'
                        checked={selected[2]}
                        className='align-middle text-blue-600 bg-slate-100 border-slate-300 rounded focus:ring-blue-500 focus:ring-2 cursor-pointer'
                        // 選択したら状態管理変数に真偽値を代入
                        onChange={(e: ChangeEvent<HTMLInputElement>) => {
                          const newSelected = [...selected]
              ...
              {/* 3列目 */}
              <tr className='border'>
                <td className='bg-slate-100 border px-7 py-3'>2限目<br />10：50 ~ 12：20</td>
                <td className='bg-sky-200 px-7 border py-3'></td>
                <td className='bg-amber-200 px-7 border py-3'></td>
                <td className='px-7 border py-3'></td>
                <td className='px-7 border py-3'></td>
                <td className='bg-sky-200 px-7 border py-3'></td>
                <td className='bg-sky-200 px-7 border py-3'>
              ...
              {/* 4列目 */}
              <tr className='border'>
                <td className='bg-slate-100 border px-7 py-3'>3限目<br />13：00 ~ 14：30</td>
                <td className='bg-amber-200 px-7 border py-3'>ビジネストレーニング<br />織田先生<br /><br />302B</td>
                <td className='bg-amber-200 px-7 border py-3'>OT<br />サイバーコマンド<br /><br />404A</td>
                <td className='bg-amber-200 px-7 border py-3'>卒業研究<br />辻井先生<br /><br />404A</td>
                <td className='px-7 border py-3'></td>
                <td className='bg-sky-200 px-7 border py-3'>
              ...
              {/* 5列目 */}
              <tr className='border'>
                <td className='bg-slate-100 border px-7 py-3'>4限目<br />14：40 ~ 16：10</td>
                <td className='bg-amber-200 px-7 border py-3'></td>
                <td className='bg-amber-200 px-7 border py-3'></td>
                <td className='bg-amber-200 px-7 border py-3'></td>
                <td className='px-7 border py-3'></td>
                <td className='bg-sky-200 px-7 border py-3'></td>
                <td className='bg-amber-200 px-7 border py-3'>ブロックチェーン<br />中島先生<br /><br />303A</td>
              </tr>
              {/* 6列目 */}
              <tr className='border'>
                <td className='bg-slate-100 border px-7 py-3'>5限目<br />16：20 ~ 17：50</td>
                <td className='px-7 border py-3'></td>
                <td className='px-7 border py-3'></td>
                <td className='bg-amber-200 px-7 border py-3'>HR</td>
                <td className='px-7 border py-3'></td>
                <td className='px-7 border py-3'></td>
                <td className='bg-amber-200 px-7 border py-3'></td>
              </tr>
              {/* 7列目 */}
              <tr className='border'>
                <td className='bg-slate-100 border px-7 py-3'>6限目<br />18：00 ~ 19：30</td>
                <td className='px-7 border py-3'></td>
                <td className='px-7 border py-3'></td>
                <td className='px-7 border py-3'></td>
                <td className='px-7 border py-3'></td>
        ...
        <section className='flex flex-row justify-between items-center'>
          <button
            className='text-xs md:text-sm px-3 md:px-10 py-3 md:py-4 rounded-xl bg-slate-100 hover:bg-slate-200 border border-slate-200 duration-200 shadow hover:shadow-md'
